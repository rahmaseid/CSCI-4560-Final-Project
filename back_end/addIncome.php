...
$stmt->bind_param("isd", $user_id, $source, $amount);
    ...
    if ($stmt->execute()) {
        ...
        <div class='alert alert-success text-center p-5 shadow rounded'>
            <h4 class='mb-4 text-dark'>Income added successfully!</h4>
            <div class='d-flex justify-content-center gap-3'>
                <button class='btn btn-success' onclick=\"window.location.href='../front_end/addIncome.html'\">Add Another</button>
